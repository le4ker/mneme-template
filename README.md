...
5. Open the repo in Claude Code and run:
   ...
   Claude will ask which Areas you want to track and generate your personal vault
   structure and skills. This is a one-time step.
...
Built on top of [mneme](https://github.com/le4ker/mneme) by
